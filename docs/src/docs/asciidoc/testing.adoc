...
Then create a http://spockframework.org[Spock] specification and declare a `@Shared` field using the `Neo4jDatastore` constructor with the domain classes you wish to test:
