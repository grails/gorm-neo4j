...
`cypherStatic` is invoked on any domain class and returns a http://neo4j.com/docs/api/java-driver/4.0/org/neo4j/driver/Result.html[org.neo4j.driver.Result]
