...
You can also convert any http://neo4j.com/docs/api/java-driver/1.0/org/neo4j/driver/v1/Result.html[org.neo4j.driver.Result] instance to a list of domain classes:
